    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Destek Talepleri</h1>
                    <p className="text-gray-500 font-medium">İşletmelerden gelen aktif ticketlar ve SLA takibi.</p>
                </div>
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none w-64 font-medium"
                        />
                    </div>
                    <select
                        value={statusFilter}
                        onChange={e => setStatusFilter(e.target.value)}
                        className="px-4 py-2 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none font-bold text-gray-700 cursor-pointer"
                    >
            ...
            {loading ? (
                <div className="bg-white rounded-3xl p-20 text-center shadow-sm">
                    ...
                    <p className="text-gray-900 font-bold">Talepler yükleniyor...</p>
                </div>
                            ...
                            <div className="flex flex-col lg:flex-row items-stretch lg:items-center">
                                ...
                                <div className="flex-1 p-6 lg:p-8 flex gap-6 items-start">
                                    ...
                                    <div className="min-w-0 flex-1 space-y-1">
                                        <div className="flex items-center gap-3 mb-1">
                                            <span className={`text-[10px] font-extrabold uppercase tracking-widest px-2.5 py-1 rounded-full bg-gray-100 text-gray-500`}>
                                                {ticket.category}
                                            </span>
                                        ...
                                        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-bold text-gray-400">
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                <Clock size={14} />
                                                SLA: {new Date(ticket.created_at).toLocaleString('tr-TR')}
                                            </div>
                                            <div className="flex items-center gap-1.5">
                                                <Tag size={14} />
                                ...
                                <div className="p-6 lg:p-8 bg-gray-50 border-t lg:border-t-0 lg:border-l border-gray-100 flex items-center justify-between lg:justify-end gap-12">
                                    <div className="text-right hidden sm:block">
                                        <div className="text-[10px] text-gray-400 font-extrabold uppercase mb-1 tracking-widest">Abonelik</div>
                                        <div className="text-sm font-bold text-gray-700 bg-white px-3 py-1 rounded-xl shadow-sm border border-gray-100">
                                            {ticket.system_info?.plan?.toUpperCase() || 'FREE'}
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-12 h-12 bg-white text-gray-400 hover:text-blue-600 hover:bg-blue-50 border border-gray-200 rounded-2xl flex items-center justify-center transition-all shadow-sm active:scale-95"
                                    >
                ...
                <div className="bg-white rounded-3xl p-20 text-center shadow-sm border-2 border-dashed border-gray-100">
                    ...
                    <h2 className="text-xl font-bold text-gray-800">Bekleyen Talep Bulunmuyor</h2>
                    <p className="text-gray-500 mt-2 font-medium">Tüm işletmeler şu an mutlu görünüyor!</p>
                </div>
            )}
        </div>
    );
